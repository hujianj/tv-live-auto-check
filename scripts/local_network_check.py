...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--home-priority-max-age-hours", type=int, default=14 * 24, help="Hours before generated home priority hints expire")
...
def write_home_priority(result: dict[str, object], source: str, args: argparse.Namespace) -> Path:
    ...
    data = {
        "description": "Optional local/home network priority hints. Generated from the actual home network and ignored automatically after expiry.",
        ...
        "generated_at_utc": generated_utc.isoformat().replace("+00:00", "Z"),
        "expires_at_utc": expires_utc.isoformat().replace("+00:00", "Z"),
